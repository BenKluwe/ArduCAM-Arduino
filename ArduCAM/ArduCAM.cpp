...
/*------------------------------------
  ...
  2016/09/29  V3.5.2  by Lee  Optimize the OV5642 register settings
        2016/10/05	V4.0.0	by Lee	Add support for second generation
  hardware platforms like ArduCAM shield V2,
  ArduCAM-Mini-5MP-Plus(OV5642/OV5640). 2016/10/28  V4.0.1  by Lee	Add
  support for Raspberry Pi 2017/04/27  V4.1.0  by Lee	Add support for
  OV2640/OV5640/OV5642 functions. 2017/07/07  V4.1.0  by Lee	Add support for
  ArduCAM_ESP32 paltform 2017/07/25  V4.1.1  by Lee	Add support for MT9V034
  --------------------------------------*/
...
#elif (defined(ESP8266) || defined(ESP32) || defined(TEENSYDUINO) ||           \
       defined(NRF52840_XXAA) || defined(PICO_BOARD))
  B_CS = CS;
#else
...
#elif defined(PICO_BOARD)
  sbi(P_CS, B_CS);
#elif (defined(ESP8266) || defined(__arm__) || defined(TEENSYDUINO))
